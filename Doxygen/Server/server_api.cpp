...
/**
 * @brief Конструктор, запускающий сервер и инициализирующий базу данных.
 */
...
/**
 * @brief Добавляет AES-ключ для определённого клиента.
 * @param socket Сокет клиента.
 * @param key Ключ AES в виде QByteArray.
 */
...
/**
 * @brief Инициализация подключения к базе данных и создание таблиц.
 */
...
/**
 * @brief Обрабатывает новое входящее подключение от клиента.
