...
QString func2client::registerUser(const QString& login, const QString& password, const QString& surname, const QString& name) {
...
QString func2client::loginUser(const QString& login, const QString& password) {
